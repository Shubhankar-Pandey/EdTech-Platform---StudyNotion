...
export const fetchCourseDetails = async (courseId) => {
  ...
  let result = null
  try {
    // console.log("befor api call ", courseId);
...
export const createSubSection = async (data) => {
  ...
  // console.log("data passed in API connector");
  // console.log("data :", [...data.entries()]);
  ...
  try {
    ...
    console.log(
      "CREATE SUB-SECTION API RESPONSE............",
      response
    );
...
export const deleteSubSection = async (data) => {
  // console.log("data in deletesubSection is : ", data);
  let result = null
  const toastId = toast.loading("Loading...")
  try {
